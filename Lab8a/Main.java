...
import code5.*;
import java.util.*;
import static code.MyArrDemo.selectionSort;
...
public class Main {
    ...
    static void demo1() {
        ...
        // Using a lambda expression to create the comparator
    ...
    static void demo2() {
        ...
        // Sort the list by luckyNumber in ascending order using Comparator.comparing()
