...
static void q1() { System.out.println("-q1----");
    ...
    /* your code 1  Given 2 arraylist of same types, listA and listB. Add all elements from listB to listA.*/
    /*add element in list b to list a */
    listA.addAll(listB);
...
static void q3() {
    ...
    static void q4() {
        ...
        = new ArrayList<>(Arrays.asList("jack","pomeranian", "terrier", "jack", "beagle"));
