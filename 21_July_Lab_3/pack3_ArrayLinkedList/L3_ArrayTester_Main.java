import code.MyArray;
import code.MyArrayBasic_65011446;
...
public class L3_ArrayTester_Main {
    ...
    static private void arrayBasic_demo1() {
        MyArrayBasic_65011446 demo = new MyArrayBasic_65011446(7,6,8,1,2,3);
        System.out.println(demo);
        }
        static private void arrayBasic_demo2() {
        MyArrayBasic_65011446 demo = new MyArrayBasic_65011446();
        demo.insert(9, 0);
        demo.insert(7,0);
        demo.insert(5,0);
        System.out.println(demo);
    ...
    static private void arrayBasic_demo3() {
        MyArrayBasic_65011446 demo = new MyArrayBasic_65011446(null);
